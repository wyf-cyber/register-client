        ...
        <div class="layout-container">
            ...
            <div class="layout-main" :style="mainContentStyle">
                <div class="content-wrapper">
                    ...
                    <div v-else>
                        <!-- 评论列表 -->
                        <div v-if="activeTab === 'commentsList'" class="comments-container">
                            <!-- 搜索栏 -->
                            <div class="filter-bar">
                                <div class="search-box">
                                    ...
                                    <button class="search-btn" @click="getCommentsByDoctor">
                                        <i class="ivu-icon ivu-icon-ios-search search-icon"></i>
                                        搜索
                                    </button>
                                </div>
                            </div>
                                ...
                                <div class="comment-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="rating-selector">
                                            <span v-for="i in 5" :key="i" class="star-selector" 
                                                :class="{ 'selected': i <= newComment.rating, 'hovered': i <= hoverRating }"
                                                @click="newComment.rating = i"
                                                @mouseover="hoverRating = i"
                                                @mouseleave="hoverRating = 0">★</span>
                                            <span class="rating-text">{{ newComment.rating }} 星</span>
                                        </div>
                                    </div>
